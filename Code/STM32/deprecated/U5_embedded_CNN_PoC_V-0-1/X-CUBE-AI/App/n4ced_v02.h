...
#ifndef AI_N4CED_V02_H
#define AI_N4CED_V02_H
#pragma once
...
/******************************************************************************/
#define AI_N4CED_V02_MODEL_NAME          "n4ced_v02"
#define AI_N4CED_V02_ORIGIN_MODEL_NAME   "n4ced_v02_lite"

/******************************************************************************/
#define AI_N4CED_V02_ACTIVATIONS_ALIGNMENT   (4)



/******************************************************************************/
#define AI_N4CED_V02_IN_NUM        (1)

AI_DEPRECATED
#define AI_N4CED_V02_IN \
  ai_n4ced_v02_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_N4CED_V02_IN_SIZE { \
  AI_N4CED_V02_IN_1_SIZE, \
}
#define AI_N4CED_V02_IN_SIZE_BYTES { \
  AI_N4CED_V02_IN_1_SIZE_BYTES, \
}
#define AI_N4CED_V02_IN_1_HEIGHT      (48)
#define AI_N4CED_V02_IN_1_WIDTH       (28)
#define AI_N4CED_V02_IN_1_CHANNEL     (1)
#define AI_N4CED_V02_IN_1_SIZE        (48 * 28 * 1)
#define AI_N4CED_V02_IN_1_SIZE_BYTES  (5376)

/******************************************************************************/
#define AI_N4CED_V02_OUT_NUM       (1)

AI_DEPRECATED
#define AI_N4CED_V02_OUT \
  ai_n4ced_v02_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_N4CED_V02_OUT_SIZE { \
  AI_N4CED_V02_OUT_1_SIZE, \
}
#define AI_N4CED_V02_OUT_SIZE_BYTES { \
  AI_N4CED_V02_OUT_1_SIZE_BYTES, \
}
#define AI_N4CED_V02_OUT_1_CHANNEL     (7)
#define AI_N4CED_V02_OUT_1_SIZE        (7)
#define AI_N4CED_V02_OUT_1_SIZE_BYTES  (28)

/******************************************************************************/
#define AI_N4CED_V02_N_NODES (9)
 ...
 * @ref ai_n4ced_v02_create. Both the activations memory buffer 
 ...
 * using @ref ai_n4ced_v02_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_n4ced_v02_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_n4ced_v02_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_N4CED_V02_*
 * defines into file @ref n4ced_v02.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_n4ced_v02_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_N4CED_V02_H */
